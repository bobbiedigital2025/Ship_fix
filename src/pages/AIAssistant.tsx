...
import { Brain, Navigation, MessageCircle, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Get help from our AI assistant, discover your brand identity with Aura, or follow interactive guided tours
          </p>
        </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  ...
                  Aura - Brand Discovery Assistant
                </CardTitle>
              </CardHeader>
