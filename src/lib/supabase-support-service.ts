  ...
  static async createTicket(ticket: Omit<SupportTicket, 'id' | 'createdAt' | 'updatedAt' | 'status'>): Promise<SupportTicket> {
    try {
      ...
      const supportTicket: SupportTicket = {
        ...
        category: newTicket.category as 'billing' | 'technical' | 'account' | 'integration' | 'general',
        severity: newTicket.severity as 'low' | 'medium' | 'high' | 'critical',
  ...
  static async getTickets(): Promise<SupportTicket[]> {
    try {
      ...
      const supportTickets: SupportTicket[] = tickets.map((ticket: DbSupportTicket) => ({
        ...
        company: ticket.company,
        category: ticket.category as 'billing' | 'technical' | 'account' | 'integration' | 'general',
  ...
  static async updateTicketStatus(id: string, status: 'open' | 'in-progress' | 'resolved' | 'closed'): Promise<SupportTicket | null> {
    try {
      ...
      const supportTicket: SupportTicket = {
        ...
        category: updatedTicket.category as 'billing' | 'technical' | 'account' | 'integration' | 'general',
        severity: updatedTicket.severity as 'low' | 'medium' | 'high' | 'critical',
        subject: updatedTicket.subject,
        description: updatedTicket.description,
        status: updatedTicket.status as 'open' | 'in-progress' | 'resolved' | 'closed',
  ...
  static async getCustomers(): Promise<CustomerProfile[]> {
    try {
      ...
      const customerProfiles: CustomerProfile[] = customers.map((customer: DbCustomer) => ({
        ...
        tier: customer.tier as 'basic' | 'premium' | 'enterprise',
